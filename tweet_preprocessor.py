...
class TWPreprocessor:
    @classmethod
    def preprocess(cls, tweet,poi_tweet=False,is_keyword=False,isreply=False):
        '''
        ...
        if poi_tweet:
            ...
            #print(_get_tweet_date(tweet._json['created_at']))           
        ...
        if isreply:
            ...
            preprocess_tweet['tweet_text'] = tweet.text.split(' ', 1)[1]
            cleaned_text = _text_cleaner(tweet.text.split(' ', 1)[1])[0]
            preprocess_tweet['reply_text'] = cleaned_text
            if tweet.lang == 'en':
                preprocess_tweet['country'] = 'USA'
                preprocess_tweet['tweet_lang']='en'
                preprocess_tweet['text_en'] = cleaned_text
